...
if (darkM) {
  darkM.addEventListener('click', function() {
    ...
    newLink1.href = 'css/darkModeCss/darkModeContact.css';
    ...
    if (isDarkMode) {
      const oldLink1 = document.querySelector('link[href="css/darkModeCss/darkModeContact.css"]');
      if (oldLink1) {
        oldLink1.remove();
      }
      ...
      defaultLink1.href = 'css/Contact.css';
      ...
      const oldLink1 = document.querySelector('link[href="css/Contact.css"]');
      if (oldLink1) {
        oldLink1.remove();
      }
