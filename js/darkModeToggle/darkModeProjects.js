...
if (darkM) {
  darkM.addEventListener('click', function() {
    ...
    newLink1.href = 'css/darkModeCss/darkModeProjects.css';
    ...
    if (isDarkMode) {
      const oldLink1 = document.querySelector('link[href="css/darkModeCss/darkModeProjects.css"]');
      if (oldLink1) {
        oldLink1.remove();
      }
      ...
      defaultLink1.href = 'css/Projects.css';
      ...
      const oldLink1 = document.querySelector('link[href="css/Projects.css"]');
      if (oldLink1) {
        oldLink1.remove();
      }
